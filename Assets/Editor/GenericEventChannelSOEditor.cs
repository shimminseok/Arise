...
/// <summary>
/// GenericEventChannelSO<>를 상속하는 모든 클래스에 대한 커스텀 에디터입니다.
/// 인스펙터에 "Find References in Current Scene" 버튼을 추가합니다.
/// </summary>
// `true` 파라미터를 사용하여 상속받는 모든 자식 클래스에 이 에디터를 적용합니다.
[CustomEditor(typeof(GenericEventChannelSO<>), true)] 
public class GenericEventChannelSOEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (!Application.isPlaying)
        {
            ...
            {
                // `target`은 현재 인스펙터에서 보고 있는 ScriptableObject 에셋입니다.
